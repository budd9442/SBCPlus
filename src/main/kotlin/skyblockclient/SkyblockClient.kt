...
class SkyblockClient {
    ...
    companion object {
        const val MOD_ID = "dungeons_guide_loader"
        const val MOD_NAME = "dungeons_guide_loader"
        const val MOD_VERSION = "v1"
        ...
        val keyBinds = arrayOf(
            ...
            KeyBinding("Toggle AntiAFK", Keyboard.KEY_COMMA, "Skyblock Client"),
            KeyBinding("dev key", Keyboard.KEY_GRAVE, "Skyblock Client"),
            KeyBinding("lava esp", Keyboard.KEY_NUMPAD4, "Lava esp"),
        )
